...
write.csv(df_vocabulary_general, file = here("data/processed/lanupro_vocabulary_general.csv"), row.names = FALSE, col.names = TRUE)
write.csv(df_vocabulary_fatty_acids, file = here("data/processed/lanupro_vocabulary_fatty_acids.csv"), row.names = FALSE, col.names = TRUE))
write.csv(df_vocabulary_incubations, file = here("data/processed/lanupro_vocabulary_incubations.csv"), row.names = FALSE, col.names = TRUE))
